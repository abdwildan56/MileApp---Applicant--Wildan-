...
WebUI.setText(findTestObject('Register Page/Company_field'), '')
...
WebUI.verifyElementText(findTestObject('Register Page/Error_messages'), 'The organization name field is required.', FailureHandling.STOP_ON_FAILURE)
