...
WebUI.setText(findTestObject('Register Page/Phone_field'), '')
...
WebUI.verifyElementText(findTestObject('Register Page/Error_messages'), 'The phone field is required.', FailureHandling.STOP_ON_FAILURE)
