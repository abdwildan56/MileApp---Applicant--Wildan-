...
WebUI.setText(findTestObject('Register Page/Fullname_field'), '')
...
WebUI.verifyElementText(findTestObject('Register Page/Error_messages'), 'The full name field is required.', FailureHandling.STOP_ON_FAILURE)
